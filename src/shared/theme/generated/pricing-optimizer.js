...
/**
 * pricing-optimizer theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { pricingOptimizerTheme } from './pricing-optimizer';
 *   import './pricing-optimizer.css';
 */
export const pricingOptimizerTheme = {
  ...
  tokens: {
    ...
    "--color-background-surface": "light-dark(#fffdf9, #1b1d21)",
    "--color-background-body": "light-dark(#f7f4ee, #141518)",
    "--color-background-card": "light-dark(#fffdf9, #1b1d21)",
    "--color-background-popover": "light-dark(#fffdf9, #1b1d21)",
    "--color-background-muted": "light-dark(#f2efe7, #212429)",
    "--color-accent": "light-dark(#1d1a15, #ebebeb)",
    ...
    "--color-text-primary": "light-dark(#1d1a15, #fafafa)",
    "--color-text-secondary": "light-dark(#5b574e, #a3a3a3)",
    ...
    "--color-success": "light-dark(#2f9d5b, #9fe59b)",
    ...
    "--color-border": "light-dark(#e3ddd0, #FFFFFF1A)",
    "--color-border-emphasized": "light-dark(#cec7b7, #525252)",
    ...
    "--color-icon-orange": "light-dark(#a97812, #ffa258)",
    ...
    "--color-icon-teal": "light-dark(#13867a, #7ec6b8)",
    ...
    "--color-icon-pink": "light-dark(#ad4a63, #ff99c3)",
