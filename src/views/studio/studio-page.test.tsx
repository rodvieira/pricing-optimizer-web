...
import type { Generation, StreamEvent } from "@/shared/domain";

const mockSearchParams = vi.fn(() => new URLSearchParams());
vi.mock("next/navigation", () => ({
  useSearchParams: () => mockSearchParams(),
}));
vi.mock("@/shared/api/analyze", () => ({ analyzeSite: vi.fn() }));
vi.mock("@/shared/api/generate", () => ({ streamGeneration: vi.fn() }));
vi.mock("@/shared/api/export", () => ({ exportVariation: vi.fn() }));
